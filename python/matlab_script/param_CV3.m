...
[n m]=size(dep);
x=xx(3)+[0:m-1]*dx;           % change
y=yy(3)+[0:n-1]*dx;           % change

[lonR latR]=meshgrid(x,y);

% cases --------
cases={'CFS', 'CVV80' 'LIS' 'PR'};
numb={'0712', '0706' '0824' '0808'};        % change

xyname='CV3_xy.txt';   % change
% --------------
