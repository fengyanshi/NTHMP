...
[n m]=size(dep);
x=xx(2)+[0:m-1]*dx;           % change
y=yy(2)+[0:n-1]*dx;           % change

[lonR latR]=meshgrid(x,y);

% cases --------
cases={'CFS', 'CVV80' 'LIS' 'PR'};
numb={'0826', '0630' '0647' '0737'};        % change

xyname='CV2_xy.txt';   % change
% --------------
